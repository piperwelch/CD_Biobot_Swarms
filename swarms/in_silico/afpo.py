...
class AFPO:
    ...
    def __init__(self, random_seed, gens, popsize, checkpoint_every=50):
    ...
    def create_initial_population(self):
        ...
        for i in range(self.popsize): # initialize random swarms
            self.pop.append(Swarm(id=self.next_id, bot_composition=np.random.choice(self.all_bots_pickles, constants.SWARM_SIZE)))
    ...
    def run(self, continue_from_checkpoint=False, additional_gens=0):
        if continue_from_checkpoint:
            ...
            # print(self.curr_gen, self.fitness_data)
    ...
    def insert_random(self, children):
        children.append(Swarm(id=self.next_id, bot_composition=np.random.choice(self.all_bots_pickles, constants.SWARM_SIZE)))
        self.next_id += 1
        return children
    ...
    def submit_batch(self):
        ...
        n_jobs = int(os.system("squeue -u pwelch1 | wc -l")) 
    ...
    def save_checkpoint(self):
        ...
        filename = 'checkpoints/afpo_age_bug_fixed_run{}_{}gens.p'.format(self.seed, self.curr_gen)
...
class Swarm:
    ...
    def __init__(self, id, bot_composition):
        self.id = id
    ...
    def get_random_initial_locations(self):
        ...
        bot1_loc = (np.random.randint(0, 12), np.random.randint(0, 12)) # bottom left starting quadrant
        bot2_loc = (np.random.randint(0, 12), np.random.randint(18, 30)) # bottom left starting quadrant
        bot3_loc = (np.random.randint(18, 30), np.random.randint(0, 12)) # bottom left starting quadrant
        bot4_loc = (np.random.randint(18, 30), np.random.randint(18, 30)) # bottom left starting quadrant
